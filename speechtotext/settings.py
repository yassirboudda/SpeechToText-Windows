"""Settings dialog using tkinter (Windows)."""
...
def show_settings(app):
    ...
    # ── API Key ──
    tk.Label(win, text='Mistral API Key', font=('Segoe UI', 10, 'bold'),
    ...
    key_entry = tk.Entry(key_frame, textvariable=key_var, show='•',
                         font=('Segoe UI', 11), bg='#181825', fg='#cdd6f4',
    ...
    test_status = tk.Label(test_frame, text='', font=('Segoe UI', 9),
    ...
    # ── Auto type toggle ──
    tk.Label(win, text='Behavior', font=('Segoe UI', 10, 'bold'),
